...
public class StudentDao {
    ...
    public int insert(Student student) {
        ...
        try {
            ...
            StudentDao.setStudentsData(student, ps);
            st = ps.executeUpdate();
    ...
    public static void getStudentsData(Student student, ResultSet rs) throws SQLException {
    ...
    public static void setStudentsData(Student student, PreparedStatement ps) throws SQLException {
